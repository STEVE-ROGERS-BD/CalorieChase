...
- **Hardware**: 
  ...
  - Step counter sensor (optional, but recommended for accurate tracking)
  - Internet connection (required for map data and AI features)
- **Permissions Required**:
  - Location (Fine & Coarse) - for tracking your workout route
  - Background Location - for continuous tracking during sessions
  - Activity Recognition - for step counting
  - Internet & Network State - for map and API access
  - Foreground Service - for background tracking

### Installation Steps

#### Step 1: Download the APK
Click the button below to download the latest version of CalorieChase:
...
> **Note**: On Android 8.0+, you'll be prompted to allow installation when you open the APK file.

#### Step 3: Install the APK
1. Open the downloaded APK file from your **Downloads** folder
2. Tap **Install** when prompted
3. Wait for the installation to complete
4. Tap **Open** to launch CalorieChase

#### Step 4: Grant Permissions
On first launch, CalorieChase will request necessary permissions:

1. **Location Access**: Tap **Allow** and select **Allow all the time** for best experience
2. **Activity Recognition**: Tap **Allow** to enable step counting
3. **Other Permissions**: Grant as requested for full functionality
...
1. Enter your personal details:
   ...
   - Weight
   - Gender
2. Review the app tutorial
3. You're ready to start your first treasure hunt!

### Getting Started
1. On the **Home** tab, tap **Start Session**
2. Choose your workout mode (Walk/Jog/Run)
3. Set your desired distance
4. Optionally add a custom prompt for AI route generation
5. Tap **Generate Route** and start your adventure!

### Troubleshooting

**Installation Blocked?**
- Make sure "Install unknown apps" is enabled for your browser/file manager
- Check if you have enough storage space (minimum 100 MB)

**Location Not Working?**
- Ensure GPS is enabled in your device settings
- Grant "Allow all the time" location permission for background tracking
- Check if Location Services are enabled

**Step Counter Not Accurate?**
- Verify your device has a step counter sensor (most modern phones do)
- Ensure Activity Recognition permission is granted
- Calibrate by entering accurate personal information (height, weight, age)

**App Crashes or Freezes?**
- Clear app cache: Settings > Apps > CalorieChase > Storage > Clear Cache
